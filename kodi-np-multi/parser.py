...
def get_media_handler(playback_type):
    ...
    Args:
        playback_type (str): Type of media ('movie', 'episode', 'song', or 'unknown')
    ...
    elif playback_type == "unknown":
        # For unknown types (like YouTube videos, plugins, etc.), treat as movie/video
        import movie_nowplaying
        return movie_nowplaying
    else:
        # Fallback to movie handler for any other unknown types
        import movie_nowplaying
        return movie_nowplaying
